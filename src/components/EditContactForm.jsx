...
import './AddContactForm.css'; // Reusing the same styles

function EditContactForm({ contact, onUpdateContact, onCancel, existingContacts }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.phone.trim()) {
      ...
      const duplicateContact = existingContacts.find(
        c => c.id !== contact.id && c.phone === formData.phone.trim()
      );
      if (duplicateContact) {
          ...
          <div className="form-group">
            ...
            <div className="image-upload-container">
              {previewUrl ? (
                ...
                <label htmlFor="edit-avatar" className="image-upload-label">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
